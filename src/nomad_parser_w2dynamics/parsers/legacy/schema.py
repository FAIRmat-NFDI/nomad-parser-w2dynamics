...
#     x_w2dynamics_config_atoms = SubSection(
#         sub_section=x_w2dynamics_config_atoms_parameters.m_def, repeats=True
#     )
...
#     x_w2dynamics_ineq = SubSection(
#         sub_section=x_w2dynamics_quantities.m_def, repeats=True
#     )
